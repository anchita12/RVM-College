...
$courses_sql = "SELECT sno, class_description FROM class_detail WHERE regular_admin = 1 ORDER BY class_description ASC";
...
<div class="container mt-4 no-print text-center">
    ...
    <a href="admin_result.php" class="btn btn-secondary btn-lg ms-2">Back to Search</a>
</div>
